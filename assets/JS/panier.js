...
function total(minus) {
    ...
    let stotprice = (stot - minus).toFixed(2)
    stotal.innerHTML = stotprice
    if (stotprice > 20) {
        livraisons.innerHTML = "0.00"
    }
    else{
        livraisons.innerHTML = 2.99
    }
    total.innerHTML = (Number(stotal.innerHTML) + Number(livraisons.innerHTML)).toFixed(2)
}
total(0)